export function Gestures() {
  return (
    <>
      <media-gesture class="absolute inset-0 z-0 block size-full" event="pointerup" action="toggle:paused" />
      <media-gesture class="absolute inset-0 z-0 block size-full" event="dblpointerup" action="toggle:fullscreen" />
