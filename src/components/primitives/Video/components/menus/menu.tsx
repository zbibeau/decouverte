...
export function Menu(props: MenuProps) {
  return (
    <media-menu>
      <Tooltip
        triggerSlot={
          <media-menu-button class="group relative mr-0.5 inline-flex size-10 cursor-pointer items-center justify-center rounded-md outline-none ring-inset ring-media-focus hover:bg-white/20 aria-hidden:hidden data-[focus]:ring-4">
            {props.buttonSlot}
          </media-menu-button>
        }
